        ...
        <Box component={"div"} className="chip-container bg-white">
          <div className="flex flex-row">
            ...
            <Box component={"div"} className="body-parts-container">
              <h3 className="font-bold hfont">Body Parts</h3>
              <ul>
                {chipData.map((data) => (
          ...
          <div>
            <Box component={"div"} className="selected-chip-container">
              <h3 className="font-bold hfont">Selected Symptoms</h3>
          ...
          <div className="flex flex-row mt-0">
            ...
            <Box component={"div"} className="chip-show-container ">
              <h3 className="font-bold hfont text-[rgb(40,48,115)]" id="choose-symptoms">
